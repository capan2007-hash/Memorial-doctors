// Kaynak deseni: /src/features/i18n-content/useTranslated.ts (web) — RN'e aynı
// sözleşmeyle uyarlandı. Faz M2 Task 9. Serbest metin (hasta notu, doktor yanıtı vb.)
// için `translate` edge function'ını sarmalayan hook. Katalog adları (name_i18n) bu
// hook'a dokunmaz.
