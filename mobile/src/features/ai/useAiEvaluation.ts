// Kaynak: /src/features/ai/useAiEvaluation.ts (web) — ai_evaluation satırını
// sorgular ve sonuç gelene kadar (en fazla ~2 dk) 5 sn'de bir yeniden dener.
// RLS gereği agent rolü için boş dönebilir — bu durumda null (hata değil)
// döner. Doktorun kendi geri bildirim satırı için useAiFeedbackFor de burada.
